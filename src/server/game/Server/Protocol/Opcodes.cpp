...
void InitOpcodes()
{
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ENABLE_TAXI,                             STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTaxiQueryAvailableNodes   );
	...
	DEFINE_OPCODE_HANDLER(CMSG_ONLINE_SHOP_QUERY,                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleOnlineShopQueryOpcode      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REALM_NAME_QUERY,                        STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleRealmNameQueryOpcode      );
	...
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_CAN_FLY,                        STATUS_UNHANDLED, PROCESS_THREADSAFE,   &WorldSession::Handle_NULL);
	//DEFINE_OPCODE_HANDLER(CMSG_MOVE_SPLINE_DONE,                        STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveSplineDoneOpcode      );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BUY_SUCCEEDED,                           STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	DEFINE_OPCODE_HANDLER(SMSG_ONLINE_SHOP_QUERY_RESULT,                STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SEND_UNLEARNED_SPELLS,                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
  ...
  //DEFINE_OPCODE_HANDLER(CMSG_TAXI_CLEAR_ALL_NODES,                    STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TAXI_ENABLE_ALL_NODES,                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TAXI_NODE_STATUS_QUERY,                  STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TAXI_ENABLE_NODE,                        STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
  //DEFINE_OPCODE_HANDLER(CMSG_TAXI_SHOW_NODES,                         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
